...
public class AnnotatedFieldResolverFactoryImpl implements FieldResolverFactory {
    ...
    private void initializeFieldResolver(final DefaultFieldResolverImpl resolver, final ProtoField annotation)
        ...
        resolver.setTypeConverter(AnnotationUtils.createTypeConverter(annotation));
