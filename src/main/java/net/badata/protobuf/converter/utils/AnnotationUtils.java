...
public class AnnotationUtils {
     ...
     */
    public ProtoClass findProtoClass(final Class<?> domainClass, final Class<? extends Message> protobufClass) {
     ...
     *                          public.
     */
    public Mapper createMapper(final ProtoClass annotation) throws MappingException {
        try {
     ...
     */
    public FieldResolverFactory createFieldFactory(final ProtoClass annotation) throws MappingException {
        try {
            ...
            throw new MappingException(
                "Make default constructor public for " + annotation.fieldFactory().getSimpleName(),
                e
            );
        }
    }
     ...
     *                        public.
     */
    public TypeConverter<?, ?> createTypeConverter(final ProtoField annotation) throws WriteException {
        try {
            ...
            throw new WriteException(
                "Make default constructor public for " + annotation.converter().getSimpleName(),
                e
            );
        }
    }
     ...
     */
    public NullValueInspector createNullValueInspector(final ProtoField annotation) throws WriteException {
        try {
            ...
            throw new WriteException(
                "Make default constructor public for " + annotation.nullValue().getSimpleName(),
                e
            );
        }
    }
     ...
     */
    public DefaultValue createDefaultValue(final ProtoField annotation) throws WriteException {
        try {
            ...
            throw new WriteException(
                "Make default constructor public for " + annotation.defaultValue().getSimpleName(),
                e
            );
        }
    }
