...
public class ClientWindow
    implements
        LoginView.OnLoginActionListener, AddBookView.OnAddBookActionListener, LibraryView.OnLibraryActionListener {
    ...
    public ClientWindow() {
        ...
        final JFrame windowFrame = new JFrame("Library: Protobuf Converter Test Application");
    ...
    private void updateLibraryView(final List<ReadingBook> books) {
        SwingUtilities.invokeLater(() -> libraryView.updateList(books));
    }
    ...
    public void onAddBook(final String title, final String author, final int pages) {
        final ReadingBook book = new ReadingBook();
